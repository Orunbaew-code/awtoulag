...
<body>
    <?php 
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
          ...
          $sql = "INSERT INTO news (news_a, news_p) VALUES ('$news_title', '$news_content')";
          $result = $conn->query($sql);
      
          if ($result) {
            echo "<p class='success'>Täzelik üstünlükli goşuldy!</p>";
          } else {
